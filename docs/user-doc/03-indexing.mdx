...
let b = a.slice([.., 1..3, ..2]);
```
<img src="/img/ferris/does_not_compile.svg" alt="does_not_compile" title="Does Not Compile!" /> </div>
...
```
<img src="/img/ferris/panics.svg" alt="panics" title="This code panics!" /> </div>
...
```
<img src="/img/ferris/not_desired_behavior.svg" alt="not_desired_behavior" title="Not desired behavior!" /> </div>
