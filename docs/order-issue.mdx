...
```rust file=order_issue anchor=example_device_change_panics
```
...
<div className="ferris-overlay">
```rust file=order_issue anchor=example_broadcast_elementwise_fail_01
```
<img src={useBaseUrl("/img/ferris/panics.svg")} alt="panics" title="This code will panic!" /> </div>
</TabItem>
</Tabs>
...
<div className="ferris-overlay">
```rust file=order_issue anchor=example_broadcast_elementwise_fail_02
```
<img src={useBaseUrl("/img/ferris/panics.svg")} alt="panics" title="This code will panic!" /> </div>
</TabItem>
