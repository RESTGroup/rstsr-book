...
## Default Row/Column Major Determined by Cargo Feature
...
## Runtime Modification of Tensor Layout via Device Settings

RSTSR also allows modifying row/column-major order at runtime through `device.set_default_order`:

```rust file=order_issue anchor=example_device_change
```
...
```rust file=order_issue anchor=example_device_change_panics ferris=panics
```
...
```rust file=order_issue anchor=example_device_change_to_device
```

## Result Differences Caused by Row/Column Major
...
```rust file=order_issue anchor=example_reshape
```
...
```rust file=order_issue anchor=example_broadcast_elementwise_setting_01
```
</TabItem>
<TabItem value="row-major" label="Row-major" default>
```rust file=order_issue anchor=example_broadcast_elementwise_01
```
</TabItem>
<TabItem value="col-major" label="Column-major">
```rust file=order_issue anchor=example_broadcast_elementwise_fail_01 ferris=panics
```
</TabItem>
</Tabs>
...
<Tabs>
<TabItem value="prob-setting" label="Problem Setting">
```rust file=order_issue anchor=example_broadcast_elementwise_setting_02
```
</TabItem>
<TabItem value="row-major" label="Row-major">
```rust file=order_issue anchor=example_broadcast_elementwise_fail_02 ferris=panics
```
</TabItem>
<TabItem value="col-major" label="Column-major" default>
```rust file=order_issue anchor=example_broadcast_elementwise_02
```
</TabItem>
</Tabs>
...
## Performance Differences Between Row/Column Major?
...
## Motivation: Why Support Both Layouts?
