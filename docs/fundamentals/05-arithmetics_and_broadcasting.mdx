...
```rust file=arithmetics_and_broadcasting anchor=basic_arithmetics_02
```

For some special cases, bit operations and shift are also available:

```rust file=arithmetics_and_broadcasting anchor=basic_arithmetics_03
```
...
```rust file=arithmetics_and_broadcasting anchor=star_as_elem_mult
```
...
```rust file=arithmetics_and_broadcasting anchor=true_rem
```
...
```rust file=arithmetics_and_broadcasting anchor=confusing_percent_01
```
...
```rust file=arithmetics_and_broadcasting anchor=confusing_percent_02 ferris=not_desired_behavior
```
...
### Example of elementwise multiplication
...
```rust file=arithmetics_and_broadcasting anchor=lt_os_mp2_01
```
...
```rust file=arithmetics_and_broadcasting anchor=lt_os_mp2_02
```
...
```rust file=arithmetics_and_broadcasting anchor=lt_os_mp2_03
```
...
```rust file=arithmetics_and_broadcasting anchor=lt_os_mp2_04
```
...
```rust file=arithmetics_and_broadcasting anchor=ao2mo_vo_01
```
...
```rust file=arithmetics_and_broadcasting anchor=ao2mo_vo_02
```
...
```rust file=arithmetics_and_broadcasting anchor=ao2mo_vo_03
```
...
### Computation by arithmetic operators
...
```rust file=arithmetics_and_broadcasting anchor=memory_aspects_01
```
...
```rust file=arithmetics_and_broadcasting anchor=memory_aspects_02
```

### Computation by associated functions
