...
### Tensor to tensor ownership conversion
...
```rust file=structure_and_ownership anchor=tensor_ownership
```

### Tensor and `Vec<T>` conversion
...
```rust file=structure_and_ownership anchor=to_vec
```
...
```rust file=structure_and_ownership anchor=as_ptr_additional
```

:::

### Tensor and scalar conversion
...
```rust file=structure_and_ownership anchor=to_scalar
```
