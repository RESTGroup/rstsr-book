...
Part of this documentation has been covered in the previous two sections ([Tensor Creation](01-tensor_creation) and [Tensor Deconstruction and Ownership](02-structure_and_ownership)). In particular, [Tensor Structure and Ownership](02-structure_and_ownership) focuses on explaining RSTSR's features through code examples.
