...
<div className="ferris-overlay">
```rust file=indexing anchor=example_insert_axes_02
```
...
<div className="ferris-overlay">
```rust file=indexing anchor=example_elementwise_safe_panic
```
<img src={useBaseUrl("/img/ferris/panics.svg")} alt="panics" title="This code panics!" /> </div>
...
<div className="ferris-overlay">
```rust file=indexing anchor=example_elementwise_unchecked_not_desired
```
